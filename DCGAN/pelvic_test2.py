...
sourceWeightsPath = "output/trial08/pelvic/"
dataSourcePath = "dataSet1/pelvic/"
dataSavePath = "testResults/trial08/pelvic/"
...
#这个是真正的pathlist
pathlist = [(n+1)*3500-1 for n in range(20)]    #根据总数计算得出的每次输出epoch的下标
# print(pathlist)
...
dim = (96, 240, 384)  # [depth, height, width].
fileStartVal = 1
fileIncrement = 1
constVal = 1
