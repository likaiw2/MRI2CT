...
# display_step = 70
display_step = np.ceil(np.ceil(nTimesteps_train / batch_size) * n_epochs / 20)   #输出20个

dataSourcePath = "dataSet1/pelvic/"
dataSavePath = "output/trial08/pelvic/"
...
#trial07:全局残差块
#trial08:pelvic + 对头骨和盆骨的文件做了规范化

#trial9: batchsize=4,hiddenchannel=32
#trial10:batchsize=4,hiddenchannel=16
#trial11:batchsize=1,
...
def train(save_model=True):
    ...
    print("##train start（pelvic）##  time:",t1)
    ...
    print("##train finished(pelvic)##  time:",t2)
